...
# @class_declaration guanabana_sync_m2_paises #
class guanabana_sync_m2_paises(interna_paises, helpers.MixinConAcciones):
    pass
...
class paises(guanabana_sync_m2_paises, helpers.MixinConAcciones):
    pass
