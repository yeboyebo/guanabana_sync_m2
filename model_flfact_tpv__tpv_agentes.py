...
# @class_declaration guanabana_sync_m2_tpv_agentes #
class guanabana_sync_m2_tpv_agentes(interna_tpv_agentes, helpers.MixinConAcciones):
    pass
...
class tpv_agentes(guanabana_sync_m2_tpv_agentes, helpers.MixinConAcciones):
    pass
